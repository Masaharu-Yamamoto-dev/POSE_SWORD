...
export default function BattleArena({ bridge, view, onLoadFailed }) {
  const { unityProvider, sendMessage, isLoaded, initialisationError, loadingProgression } = useUnityContext({
    ...
    loaderUrl: '/POSE_SWORD_Unity/Builds/ver3.2/Build/ver3.2.loader.js',
    dataUrl: '/POSE_SWORD_Unity/Builds/ver3.2/Build/ver3.2.data',
    frameworkUrl: '/POSE_SWORD_Unity/Builds/ver3.2/Build/ver3.2.framework.js',
    codeUrl: '/POSE_SWORD_Unity/Builds/ver3.2/Build/ver3.2.wasm',
  });
