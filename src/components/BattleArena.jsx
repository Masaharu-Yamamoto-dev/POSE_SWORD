...
export default function BattleArena({ bridge, view, onLoadFailed }) {
  const { unityProvider, sendMessage, isLoaded, initialisationError, loadingProgression } = useUnityContext({
    loaderUrl: 'POSE_SWORD_Unity/Builds/ver3.0/ver3.0/Build/ver3.0.loader.js',
    dataUrl: 'POSE_SWORD_Unity/Builds/ver3.0/ver3.0/Build/ver3.0.data',
    frameworkUrl: 'POSE_SWORD_Unity/Builds/ver3.0/ver3.0/Build/ver3.0.framework.js',
    codeUrl: 'POSE_SWORD_Unity/Builds/ver3.0/ver3.0/Build/ver3.0.wasm',
  });
